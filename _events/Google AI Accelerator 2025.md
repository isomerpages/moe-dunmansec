...
– a hands-on AI learning experience for students organised by SG Code Campus,
in partnership with the Infocomm Media Development Authority (IMDA), Google
Cloud, and the Cancer Science Institute (CSI) at the National University
of Singapore (NUS).</p>
<p>This two-week programme brings together selected students from secondary
...
and Vertex AI. In the following week, participants will work in project
teams to tackle a real-world biomedical challenge using anonymised cancer
imaging data provided by CSI, applying machine learning to develop meaningful,
real-life solutions.</p>
<p>The programme will culminate in a final project showcase at Google HQ
...
<p></p>
<div class="isomer-image-wrapper">
<img style="width: 100%" height="auto" width="100%" alt="" src="/images/Google_AI_Acccelerator_Students.png">
</div>
<p></p>